...
import 'package:your_weather/ui/detail_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  static String API_KEY = dotenv.env['API']!;

  String location = 'Chennai'; //Default location
